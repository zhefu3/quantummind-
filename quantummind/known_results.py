...
KNOWN_RESULTS = [
    ...
    {
        "id": "quantum_pagerank",
        "problem": "PageRank / stationary distribution of a Markov chain",
        "primitive": "quantum_walk",
        "speedup": "quantum-walk PageRank; quadratic mixing-time improvements in favorable cases",
        "status": "conditional",
        "model_caveat": "single-entry query still needs an estimation step; full-ranking output "
                        "hits the readout wall",
        "reference": "Paparo-Martin-Delgado 2012; Piddock 2019",
        "keywords": ["pagerank", "stationary distribution", "random walk ranking",
                     "markov chain", "centrality"],
    },
    {
        "id": "quantum_laplacian_solver",
        "problem": "Laplacian linear systems / effective resistance",
        "primitive": "qsvt",
        "speedup": "HHL/QSVT-style exponential IF sparse, well-conditioned, aggregate readout",
        "status": "conditional",
        "model_caveat": "effective resistance is a single aggregate (favorable); full potentials "
                        "vector hits the readout wall; conditioning matters",
        "reference": "Harrow-Hassidim-Lloyd 2009; Wang 2017 (quantum graph algorithms)",
        "keywords": ["effective resistance", "laplacian", "resistor network", "graph linear system",
                     "electrical flow"],
    },
    {
        "id": "quantum_sat_search",
        "problem": "Boolean satisfiability / constraint search (SAT, CSP, bounded model checking)",
        "primitive": "grover",
        "speedup": "quadratic over brute-force assignment search; still exponential",
        "status": "proven",
        "model_caveat": "generic Grover-over-assignments; structured classical solvers (CDCL) "
                        "often beat naive search, so realistic gains are modest",
        "reference": "Grover 1996 applied to SAT; Ambainis 2004 survey",
        "keywords": ["satisfiability", "sat", "constraint satisfaction", "bounded model checking",
                     "boolean formula", "assignment search"],
    },
    {
        "id": "quantum_hitting_time_search",
        "problem": "Markov-chain search / reachability via hitting time (Szegedy walks)",
        "primitive": "quantum_walk",
        "speedup": "quadratic in hitting time for detecting/finding a marked state",
        "status": "proven",
        "model_caveat": "query model; applies to reachability / motion-planning-style search on "
                        "an implicit graph",
        "reference": "Szegedy 2004; Magniez-Nayak-Roland-Santha 2011 (MNRS)",
        "keywords": ["hitting time", "markov chain search", "reachability", "state space search",
                     "motion planning", "random walk search"],
    },
    {
